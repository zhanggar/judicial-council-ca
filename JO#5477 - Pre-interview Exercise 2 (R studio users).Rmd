...
a <- read.csv("C:/Users/garyz/OneDrive/Gary/Employment/Job documents/Judicial Council of CA/JO#5477 - Assessments Table for Interview.csv")
b <- read.csv("C:/Users/garyz/OneDrive/Gary/Employment/Job documents/Judicial Council of CA/JO#5477 - Bookings Table for Interview.csv")
View(a)
View(b)
```
